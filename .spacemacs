 ...
 '(safe-local-variable-values
   (quote
    ((eval progn
           ...
           (setenv "gna" "gnagna3"))
     (cs-workspace . "pipmonger-lab")
     (cs-project-root . "/Users/csaba/work/pipmonger/lab")))))
(custom-set-faces
